const { createCouponMaster, getAllMasterCoupon, verifyMasterCoupon } = require("../controllers/MasterCouponController");
...
router.route("/all-verify-coupon").post(isAuthenticatedUser,verifyMasterCoupon);
